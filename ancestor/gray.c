// gcc -flto -O3 -s gray.c -o gray -D T_MAX=2 -lpthread
...
static _Bool spawn_and_wait(u64_t T, void *d_arr, u64_t d_elem_sz, void* (*f)(void *)) {
...
MAIN_ARGS {
    ...
    "encode: ./gray -2 example.ppm example.gray\n"
    "decode: ./gray -d example.gray example.ppm\n"
